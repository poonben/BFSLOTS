...
def loggedIn(func):
    def checkLogin(*args, **kwargs):
        if args[0].isSupportSquare:
            ...
            args[0].callback.other('CREATOR TEAM TERMUX  SUPORT BY: ZULKIFLI MOKOAGOW')
    return checkLogin
...
class Square(object):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.log('CREATOR BOT TEAM TERMUX UNTUK PEMESANAN SC BISA PM ID LINE linux.1 ATAU diam_aja')
