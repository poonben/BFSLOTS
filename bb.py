...
try:
    ...
    import urllib2
cl = LINE("fefegi4817@jesdoit.com","Aa1234")    
...
def sendTextTemplatelike(to, text): #autolike
    data = {
                                "type": "flex",
                                "altText": "BF SLOTS เข้าใจวัยรุ่น",
                                "contents": {
  "type": "bubble",
  "size": "micro",
  "body": {
...
"flex": 0
      ...
      "contents": [
          ...
          "type": "image",
            ...
            "action": {
            "type": "uri",
            "uri": "line://nv/chat" #"https://slotthai.ml",
            },         
            "flex": 1          
            },
          {
        ...
        "contents": [
          ...
          },
          {
            ...
            "contents": [
              {
                "type": "text",
                "text": "\n◯ บล็อค\n◯ คท\n◯ ชื่อเพื่อน\n◯ ดูกลุ่ม\n◯ ลิ้งค์กลุ่ม\n◯ เปิดคิวอาร์กลุ่ม◯ ปิดคิวอาร์กลุ่ม\n◯ ค้างเชิญ\n◯ เปลี่ยนรูปกลุ่ม\n◯ สเตตัส:", #3
                "size": "xxs",
                "weight": "bold",
                "color": "#2bff44",
                "style": "normal",
    ...
    "contents": [
      ...
      },
      {
        ...
        "align": "center"
                        ...
                        elif cmd == "โปรโมท" or text.lower() == 'bfcat':                            	
                                contact = cl.getProfile()
                                mids = [contact.mid]
                                tz = pytz.timezone("Asia/Jakarta")
                                timeNow = datetime.now(tz=tz)
...
#===========BOT UPDATE============#
                        ...
                        if text.startswith('เปิดคิวอาร์ '):
                            if msg._from in admin:
                	            separate = text.split(" ")
                	            number = text.replace(separate[0] + " ","")
                	            groups = cl.getGroupIdsJoined()
                 ...
                 #               
                            ...
                            if wait["responsmule"] == True:
                                ...
                                for AsiaTeam in NurCh:
                                    ...
                                    SusuNona+="\n╰──「ᴄʀᴇᴀᴛᴏʀ: BF SLOTS เข้าใจวัยรุ่น」─────"
                                    data = {
                                        "type": "flex",
                                        "altText": "BF SLOT เข้าใจวัยรุ่น",
                                        "contents": {
...
#=========COMEN RESPON======#
                        ...
                        elif cmd == "เปิดห้ามแทค" or text.lower() == 'notag on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Mentionkick"] = True
                                sendTextTemplate1(msg.to,"ʀᴇsᴘᴏɴᴛᴀɢ ᴋɪᴄᴋ ᴍᴏᴅᴇ ᴏɴ")
                        elif cmd == "ปิดห้ามแทค" or text.lower() == 'notag off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                        ...
                        elif cmd == "เปิดเข้ากลุ่มออโต้" or text.lower() == 'autojoin on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = True
                                sendTextTemplate(msg.to,"ᴀᴜᴛᴏᴊᴏɪɴ ɢʀᴏᴜᴘ ᴏɴ")
                        elif cmd == "ปิดเช้าลุ่มออโต้" or text.lower() == 'autojoin off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = False
                        ...
                        elif cmd == "เปิดออโต้แอด" or text.lower() == 'autoadd on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = True
                        ...
                        elif cmd == "ปิดโพส" or text.lower() == 'post off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                        ...
                        elif cmd == "ปิดเชิญ" or text.lower() == 'invite on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["invite"] = True
                                sendTextTemplate1(msg.to, "ᴋɪʀɪᴍ ᴋᴏɴᴛᴀᴋ'ɴʏᴀ")
                        elif cmd == "เปิดเชิญ" or text.lower() == 'invite off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["invite"] = False
...
#===========COMMAND BLACKLIST============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["dblacklist"] = True
                                sendTextTemplate1(msg.to,"📲Kirim kontaknya...")
                        elif cmd == "บัญชีดำ" or text.lower() == 'banlist':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                        ...
                        elif cmd == "ล้างแบน" or text.lower() == 'clearban':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              wait["blacklist"] = {}
