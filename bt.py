      ...
      "styles": {
        ...
        "footer": {
          "separator": False
                ...
                cl.postTemplate(to, data)                               
def sendTextTemplatework(to, text):
    data = {"type": "flex",
 ...
 "contents":
 {
  ...
  "contents": [
    ...
    cl.postTemplate(to, data) 
    bot1.postTemplate(to, data) 

def sendTextTemplateworks(to, text):
    data = {  
 "type": "flex",
 "altText": "้โปรผีบอก....",
 "contents":
...
def sendTextTemplateworkss(to, text):
    data = {"type": "flex",
 "altText": "ฟรี 188 สมาชิกใหม่ ฝากครั้งแรก",
 "contents":
 {
                            ...
                            if msg._from in creator or msg._from in admin:
                                ...
                                for group1 in groupb:
                                    try:
                                        ...
                                        bot1.postTemplatework(group1, data)
                                    except:pass 
                                ...
                                for group in groups:
                                    try:
                                        ...
                                        cl.postTemplateworks(group, data)
                                    except:pass  
#broadcast
                          ...
                          if msg._from in admin:
                              ...
                              for contact in contacts:
                                  try:
                                    ...
                                    cl.postTemplatework(contact, data)
                                    bot1.postTemplateworks(contact, data)
                                  except:pass  
